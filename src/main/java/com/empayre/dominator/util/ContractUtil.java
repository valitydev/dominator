...
public class ContractUtil {
    public static List<com.empayre.dominator.domain.tables.pojos.ContractAdjustment> convertContractAdjustments(
            Contract contract,
            long cntrctId) {
    ...
    public static com.empayre.dominator.domain.tables.pojos.ContractAdjustment convertContractAdjustment(
            ContractAdjustment contractAdjustment,
            long contractId
    ) {
        var adjustment = new com.empayre.dominator.domain.tables.pojos.ContractAdjustment();
    ...
    public static List<com.empayre.dominator.domain.tables.pojos.PayoutTool> convertPayoutTools(
            Contract contract,
            long contractId
    ) {
    ...
    public static com.empayre.dominator.domain.tables.pojos.PayoutTool buildPayoutTool(
            long contractId,
            String payoutToolId,
        ...
        var payoutTool = new com.empayre.dominator.domain.tables.pojos.PayoutTool();
    ...
    public static com.empayre.dominator.domain.tables.pojos.PayoutTool convertPayoutTool(
            PayoutTool pt,
            long cntrctId
    ) {
    ...
    public static void setPayoutToolInfo(com.empayre.dominator.domain.tables.pojos.PayoutTool payoutTool,
                                         PayoutToolInfo payoutToolInfoSource) {
        var payoutToolInfo = TypeUtil.toEnumField(
                payoutToolInfoSource.getSetField().getFieldName(),
                com.empayre.dominator.domain.enums.PayoutToolInfo.class
        );
    ...
    public static void fillContractLegalAgreementFields(
            com.empayre.dominator.domain.tables.pojos.Contract contract,
    ...
    public static void fillReportPreferences(com.empayre.dominator.domain.tables.pojos.Contract contract,
        ...
        var reportActSignerDocument = TypeUtil.toEnumField(
                        ...
                        com.empayre.dominator.domain.enums.RepresentativeDocument.class
                );
    ...
    public static void setNullReportPreferences(com.empayre.dominator.domain.tables.pojos.Contract contract) {
